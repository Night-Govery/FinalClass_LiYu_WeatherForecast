...
from mod_timeseries.weather_model2 import ProcessData2
...
class Training2:
    def training2(self):
        ...
        train = dta.loc['1980-12-31':'2000-12-31']
        test = dta.loc['2000-12-31':'2010-12-31']
        ...
        with open('predict.json', 'a', encoding='utf-8') as f:
            ...
            for k, v in new['Prediction'].items():
                ...
                if '2010' in str(date):
                    print('--test--')
                    dd = '2020/' + str(predict_month[0]) + '/' + str(predict_day[0])
                    print(dd)
                    json.dump({dd: v}, f)
